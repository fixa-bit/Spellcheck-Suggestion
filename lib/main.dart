...
class CustomTextEditingController extends TextEditingController {
  ...
  //String mytext="check this aa ناکستان initial text ناکستان chaeck this initijal پاکستانی texet";
    String mytext=" ناکستان ناکستان پاکستانی";
...
class _EditableTextToolbarBuilderExampleAppState
    ...
    Navigator.of(context).push(
      DialogRoute<void>(
        ...
        builder: (BuildContext context) =>
            const AlertDialog(title: Text('Spell Checking and Suggestions')),
      ),
    );
  }
  ...
  //String mytext="check this aa ناکستان initial text ناکستان chaeck this aha initijal پاکستانی texet";
  String mytext=" ناکستان ناکستان پاکستانی";
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: const Text('Spell Checker and Correcter'),
        ),
        body: Center(
          child: Column(
            children: <Widget>[
