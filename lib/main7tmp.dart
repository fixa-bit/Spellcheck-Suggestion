...
class CustomTextEditingController extends TextEditingController {
  ...
  String mytext="check this aa ناکستان initial text ناکستان chaeck thifs aha initijal texet";
  ...
  TextSpan buildTextSpan(
    ...
    try {
      var encoded = utf8.encode(mytext);
...
class _EditableTextToolbarBuilderExampleAppState
  ...
  void _printLatestValue() {
    ...
    print('Second text field: $mytext (${mytext.characters.length})');
  }
  void initial_text(){
  ...
  // }
 void addToDictionary(selectedwordx){
   print(listErrorTexts);
