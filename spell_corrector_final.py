# -*- coding: utf-8 -*-
"""spell_corrector_final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FZwWn1R3oXYdKlGiWRhupGPhZZ0SMpg3
"""

from google.colab import drive
drive.mount('/content/gdrive', force_remount=True)

cd '/content/gdrive/My Drive/newdata'

inputx="ناکستان"
runcorrection(inputx)

def runcorrection(inputx):
  import numpy as np
  import difflib
  import pandas as pd
  import csv
  ...
  def editreco3(input,original,val):
      ...
      if(len(trueoutcomes)):
        ...
        #print("big")
        outcomesx=difflib.get_close_matches(input, original,1,sim_index)#input would be word selected after edit1 and original is word that was altered by edit1 function
  ...
  def knownspace(spaceset):
      ...
      spaceoptions=set(item for item in spaceset if (item[0] in WORDS and item[1] in WORDS) and len(item[1])>1 and  len(item[0])>1)
      # for item in spaceset:
...
def hello_world():
    ...
    #all_wordsx = np.load('all_words.npy')
    #scoresx = np.load('scores.npy')
    all_words=["aa","cc","ss","ww","dddd","ffff","ffffff","aaaaaaaa","kk","fffk","okk"]
    scores=["2","4","5","6","7","8","9","10","33","22","55"]
    #all_words = all_wordsx.tolist()
    #scores = scoresx.tolist()
